...
for name in NUM_GPUS NUM_GENERATIONS PER_DEVICE_TRAIN_BATCH_SIZE GRADIENT_ACCUMULATION_STEPS GENERATION_BATCH_SIZE NUM_ITERATIONS MAX_TURNS MAX_LENGTH MAX_COMPLETION_LENGTH VLLM_TP LORA_RANK LORA_ALPHA; do
    value="${!name}"
...
exec accelerate launch \
    ...
    --external_plugins spade/swift_backend/envduels_gym.py \
