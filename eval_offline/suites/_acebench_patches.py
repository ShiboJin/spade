...
_PATCH_MARKER = "SPADE_PATCH_MARKER"
...
def _patch_agent_routing(acebench: Path) -> None:
    ...
    override = (
        "        # SPADE_PATCH_MARKER: route the served (non-gpt) model to our\n"
...
def _patch_inference_map(map_file: Path) -> None:
    ...
    append_block = (
        "\n\n"
        "# SPADE_PATCH_MARKER — added by eval_offline.suites.acebench\n"
