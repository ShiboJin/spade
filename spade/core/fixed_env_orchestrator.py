...
4. Play games (reuses play_game_async pattern from SpadeOrchestrator)
...
from spade.core.difficulty_controller import DifficultyController
from spade.core.envs.env_adapter import EnvInstance, EnvironmentAdapter
from spade.core.learning_potential import GameBaselineTracker
from spade.core.model_adapter import ModelAdapter
from spade.core.types import Trajectory, TrajectoryStatus, SpadeConfig
...
def _build_initial_prompt(category: str, observation: str) -> str:
    ...
    if category == "synthetic":
        # Match SpadeOrchestrator._apply_game_template("qwen3_game") exactly
        return (
...
class FixedEnvOrchestrator:
    ...
    Unlike SpadeOrchestrator, this does not generate games. It uses
    ...
    Args:
        ...
        config: SpadeConfig for training parameters
    ...
    async def play_env_async(
        ...
        Same gameplay loop pattern as SpadeOrchestrator.play_game_async()
        ...
        # SpadeOrchestrator.play_game_async.
        ...
        try:
            for turn in range(self.config.max_turns):
                ...
                # Step environment
                # Synthetic games expect \boxed{}-extracted actions (like SpadeOrchestrator);
